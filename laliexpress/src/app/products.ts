...
export const products = [
  new Product(
    10,
    1,
    'Футболка с Путиным, футболка с коротким рукавом для верховой езды, ' +
    'Милая футболка с принтом, летняя Хлопковая мужская футболка больших размеров',
    3387.29,
    4.9,
    'https://aliexpress.ru/item/4000039801840.html?spm=a2g0s.8937460.0.0.19cf2e0eJIA2VZ',
    'https://ae01.alicdn.com/kf/H7babd37d4e194a728bea1943152bb8133/-.jpg'),
  new Product(
    11,
    1,
    'Путина с пикантные козырь на столе забавные Анти-Трамп в виде майки-футболки брендовая модная футболка',
    3220.58,
    3.6,
  ...
  new Product(
    12,
    1,
    'Трансформеры Мегатрон Косплей Костюм экран детальный носимый Косплей Костюм',
    966172.31,
    5,
  ...
  new Product(
    4,
    1,
    '100x137 см/шт. 0,1 мм/0,3 мм ТПУ дизайнерская ткань ультра ' +
  ...
  new Product(
    14,
    1,
    'Новинка 2015, надувной Забавный сексуальный женский костюм, барменка' +
  ...
  new Product(
    20,
    2,
    'Забавный графический принт сумки на плечо для женщин Николя клетка кролик' +
  ...
  new Product(
    21,
    2,
    'Забавные Наплечные сумки с графическим принтом для женщин Nicholas Cage с рисунком лица (2)' +
  ...
  new Product(
    30,
    3,
    '60 шт./бутылка, паста для пупка, прикрепленная к Южному дивизиону, палочки для прижигания,' +
  ...
  new Product(
    31,
    3,
    'Белые пигменты диоксида титана в косметическом сорте, косметические материалы порошок для ' +
  ...
  new Product(
    40,
    4,
    'Бытовая Роскошная сухой пар и влажная Паровая душевая комната Интегральная ванная комната бревна стекло для сауны',
    4242064.76,
    0,
  ...
  new Product(
    41,
    4,
    'Карнавал пространство-время туннель огромный город подземный проект ЖК видеостена',
    37678563,
    0,
  ...
  new Product(
    50,
    5,
    'Ручная Кепка Пикачу, мягкая Кепка для косплея амигуруми, плюшевые игрушки, коллекция ' +
  ...
  new Product(
    51,
    5,
    'Бесплатная доставка элегантные женские костюмы Спрей огонь ' +
  ...
  new Product(
    52,
    5,
    'Диско зеркало мяч шлем маска зеркальный костюм для DJ ночной клуб ' +
  ...
  new Product(
    53,
    5,
    'Напольная гигантская надувная резиновая модель утки желтая плавающая утка' +
  ...
  new Product(
    60,
    6,
    'Мужские ноги манекена носок дисплей/гибкий мягкий силиконовый материал',
    51150.30,
    0,
